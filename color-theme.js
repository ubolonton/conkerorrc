...
global_color_theme(
    "dark", "K",
    [make_css_data_uri(
        ['*:not(img) { background: #0C141E !important; '+
         ...
         ':visited, :visited * { color: #805DBB !important }'
        ], $url_prefixes = ["http", "about", "*"]),

     make_css_data_uri(
         ['.vh { foreground-color: #A0AFA8; '+
          ...
          '.oZ-jd,.hF,.hG { background: white !important;}' // make cursor red
         ], $domains = "mail.google.com"),

     make_css_data_uri(
         ['#current-entry { background-color: #1F282F !important;} '+
          '.entry { background-color: #0C141E !important; }'
